/**
 * CS 2003 - Lab 11 Code working with files
 *
 * @author David Magar
 * @version 1.0
 * @since 11-07-2017
...
public class fileio {
	...
	public static void checkSpeedFiles() throws IOException {
		...
		File f = new File("C:\\Users\\David\\Downloads\\Backup\\Backup\\SPEED");
	...
	public static void checkApolloFiles() throws IOException {
		...
		File f = new File("C:\\Users\\David\\Downloads\\Backup\\Backup\\APOLLO");
		File[] allFiles = f.listFiles();
		int i = 0;
